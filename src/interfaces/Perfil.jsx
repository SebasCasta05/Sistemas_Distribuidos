          ...
          <div className="perfil-header">
            ...
            <div className="perfil-info">
              ...
              <div className="perfil-acciones">
                ...
                <button className="btn-secondary" title="Ajustes">
                  <Settings size={18} />
                </button>
              </div>
            </div>
            ...
            <aside className="perfil-sidebar">
              ...
              <div className="bio-card">
                ...
                <p className="bio-text">
                  {`Usuario: ${userInfo.nombre} ${userInfo.apellido}. Dirección: ${userInfo.direccion || '—'}. Tel: ${userInfo.telefono || '—'}`}
                </p>
              </div>
            </aside>
            ...
            <main className="perfil-main">
              <div className="posts-section">
                <div className="section-header">
                  <h3 className="section-title"><Book size={20} /> Mis Publicaciones</h3>
                ...
                <div className="content-tabs">
                  ...
                  <button className={`tab-btn ${activeTab === 'proyectos' ? 'active' : ''}`} onClick={() => handleTabChange('proyectos')}>Proyectos</button>
                  <button className={`tab-btn ${activeTab === 'guardados' ? 'active' : ''}`} onClick={() => handleTabChange('guardados')}>Guardados</button>
                </div>
